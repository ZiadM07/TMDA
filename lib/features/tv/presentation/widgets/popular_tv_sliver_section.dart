...
class PopularTvSliverSection extends StatelessWidget {
  final List<TvShow> tvShows;

  const PopularTvSliverSection({super.key, required this.tvShows});
          ...
          Row(
            children: [
              ...
              InkWell(
                onTap: () {
                  context.router.push(
                    SeeAllTvRoute(category: TvCategory.popular),
                  );
                },
