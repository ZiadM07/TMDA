...
class AiringTodaySliverSection extends StatelessWidget {
  final List<TvShow> tvShows;

  const AiringTodaySliverSection({super.key, required this.tvShows});
          ...
          Row(
            children: [
              ...
              InkWell(
                onTap: () {
                  context.router.push(
                    SeeAllTvRoute(category: TvCategory.airingToday),
                  );
                },
