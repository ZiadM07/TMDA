...
class MovieDetailsSliverRecommended extends StatelessWidget {
  const MovieDetailsSliverRecommended({super.key});

  @override
  Widget build(BuildContext context) {
    final cubit = context.watch<MovieDetailsCubit>();
    final movies = cubit.recommended;
        ...
        Material(
          ...
          child: InkWell(
            ...
            onTap: () => context.pushRoute(
              SeeAllMoviesRoute(
                category: MovieCategory.recommended,
                movieId: movieId,
              ),
            ),
            child: AppText(
