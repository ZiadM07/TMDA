...
class NowPlayingSliverSection extends StatelessWidget {
  final List<Movie> movies;

  const NowPlayingSliverSection({super.key, required this.movies});
            ...
            children: [
              ...
              Material(
                ...
                child: InkWell(
                  onTap: () {
                    context.router.push(
                      SeeAllMoviesRoute(category: MovieCategory.nowPlaying),
                    );
                  },
