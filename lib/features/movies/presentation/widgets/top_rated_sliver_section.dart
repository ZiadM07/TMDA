...
class TopRatedSliverSection extends StatelessWidget {
  final List<Movie> movies;

  const TopRatedSliverSection({super.key, required this.movies});
          ...
          Row(
            children: [
              ...
              InkWell(
                onTap: () {
                  context.router.push(
                    SeeAllMoviesRoute(category: MovieCategory.topRated),
                  );
                },
